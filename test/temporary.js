...
//                 category: 8
//             }];
//         const link = [{id: '0', name: null, source: '1', target: '0', lineStyle: {normal: {}}}, {
//             id: '1',
//             name: null,
//             source: '2',
//             target: '0',
...
//         const KnowledgeOP = echarts.init(dom);
//         const option = {
//             tooltip: {},
//             legend: [{
...
//                     name: 'Dud',  // 节点名
//                     attributes: {},  // 节点属性，根据这里的数据可以对数据进行分类
//                     category: '1',  // 节点类目，比如0对应的是第一个类目，如果没有需要自己添加
//                     value: '0',  // 节点值， 一般会用节点大小来表现值的大小
//                     itemStyle: {},  // 节点样式
//                     symbol: 'circle',  // 节点图标形状
//                     synbolStyle: {},  // 节点图标样式
...
//                     name: 'Dud',  // 节点名
//                     attributes: {},  // 节点属性，根据这里的数据可以对数据进行分类
//                     category: '2',  // 节点类目，比如0对应的是第一个类目，如果没有需要自己添加
//                     value: '0',  // 节点值， 一般会用节点大小来表现值的大小
//                     itemStyle: {},  // 节点样式
//                     symbol: 'circle',  // 节点图标形状
//                     synbolStyle: {},  // 节点图标样式
...
//                     name: 'Dud',  // 节点名
//                     attributes: {},  // 节点属性，根据这里的数据可以对数据进行分类
//                     category: '3',  // 节点类目，比如0对应的是第一个类目，如果没有需要自己添加
//                     value: '0',  // 节点值， 一般会用节点大小来表现值的大小
//                     itemStyle: {},  // 节点样式
//                     symbol: 'circle',  // 节点图标形状
//                     synbolStyle: {},  // 节点图标样式
